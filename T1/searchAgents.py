...
class CornersProblem(search.SearchProblem): #! QUESTAO 4
    ...
    def getNextState(self, state, action): # aqui, vai calcular o proximo estado
        currentPosition, visitedCorners = state
        nextPosition = self.getNextPosition(currentPosition, action)
...
class ClosestDotSearchAgent(SearchAgent): #! QUESTAO 7
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state): #! QUESTAO 7
        """
